...
def setupHusky():
    ...
    settingsMsg.vehicle_length = 1.042    #[m]
    settingsMsg.vehicle_width = 0.661    #[m]
    settingsMsg.stopping_distance_1M = 0.30	#[m] - Stopping distance when traveling 1m/s
    settingsMsg.lidar_spacing = 0.91 #[m] - spacing between the lidar
    settingsMsg.laser_fov = 175.0 #[deg]
